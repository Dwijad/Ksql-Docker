...
### Run
    ...
    // Connect using $ ksql   https://ksql.default.svc:8088 --user fred --password password
    ...
    // Connect using $ ksql   http://ksql.default.svc:8088 --user fred --password password
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMjkxNDEwODEsLTkxNTczNDg2OCw5Nj
